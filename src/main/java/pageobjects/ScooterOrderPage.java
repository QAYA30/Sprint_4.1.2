...
public class ScooterOrderPage {
    ...
    private final By buttonOrderUp = By.xpath(".//div[@Class='Header_Nav__AGCXC']/button[text()='Заказать']"); // Заказать Вверху страницы

    private final By buttonOrderDown = By.xpath(".//div[@Class='Home_FinishButton__1_cWm']/button[text()='Заказать']"); // Заказать внизу страницы
    ...
    private final By nextPageButton = By.xpath(".//div[@Class='Order_NextButton__1_rCA']/button[text()='Далее']"); // "Далее"
    ...
    public void findCheckAndClickOrderButton(int type) {
        if (type == 1) {
            clickButtonOrderUp();
        } else {
    ...
    public void enterValueOrder(String name, String surname, String address, String phone, String comment) {
